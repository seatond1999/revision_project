...
for i in range(0,len(yes)):
    aqabio_data.append((reader.pages[yes[i]].extract_text(),yes_titles[i],'Yes Yes Yes Yes Yes'))
for i in range(0,len(no)):
    aqabio_data.append((reader.pages[no[i]].extract_text(),no_titles[i],'No No No No No'))
...
biscam_data = []
for i in range(0,len(yes)):
    biscam_data.append((reader.pages[yes[i]].extract_text(),yes_titles[i],'Yes Yes Yes Yes Yes'))
for i in range(0,len(no)):
    biscam_data.append((reader.pages[no[i]].extract_text(),no_titles[i],'No No No No No'))
...
edbio_data = []
for i in range(0,len(yes)):
    edbio_data.append((reader.pages[yes[i]].extract_text(),yes_titles[i],'Yes Yes Yes Yes Yes'))
for i in range(0,len(no)):
    edbio_data.append((reader.pages[no[i]].extract_text(),no_titles[i],'No No No No No'))
