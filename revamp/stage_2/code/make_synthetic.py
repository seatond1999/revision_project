...
prompt1 = f"""I want you to split text into two or three subsections and add informative titles for each subsection.
Each subsection must be in paragraph form and no information should be missing from the original text.
...
response1 = 'Yes, I understand the task. Please provide the text you would like me to split into key subsections and add informative titles for each subsection.'
