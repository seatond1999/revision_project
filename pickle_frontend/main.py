...
# %% --------------------------------------------------------------------------
import pickle
with open('pickled_variables.pkl', 'rb') as file:
    loaded_contents_first = pickle.load(file)
    loaded_contents_last = pickle.load(file)
    loaded_contents = pickle.load(file)
    loaded_chapter_breakdown = pickle.load(file)
